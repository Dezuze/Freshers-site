  ...
  return (
    <header className="nav">
      <div className="nav-inner">
        ...
        <button aria-label="menu" onClick={() => setOpen(!open)} style={{background:'transparent',border:'none',cursor:'pointer'}}>
      ...
      {open && (
        <div style={{padding:'12px 20px', borderTop:'1px solid rgba(15,23,42,0.06)', background:'#fff'}}> 
          <a href="#" style={{display:'block',padding:'8px 0'}}>Home</a>
          <a href="#schedule" style={{display:'block',padding:'8px 0'}}>Schedule</a>
        </div>
      )}
    </header>
  )
